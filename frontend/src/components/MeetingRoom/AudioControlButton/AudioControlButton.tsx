 ...
 *
 * This component displays a current status of microphone (muted/unmuted)
 * as well as shows a dropdown that displays available audio devices (microphones, speakers).

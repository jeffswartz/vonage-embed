...
import { Publisher as OTPublisher } from '@opentok/client';
...
/**
 * Video Tile Canvas - resizable container to layout and display all video tiles
 * @param {VideoLayoutProps} videoTileCanvas props

 ...
 * @param {() => void} props.handleToggle - the function that handles the toggle of video output device.
 * @param {boolean} props.isOpen - the prop that shows whether the pop up needs to be opened.
 * @param {RefObject<HTMLInputElement>} props.anchorRef - the anchor element to attach the pop up to.
 * @param {Function} props.handleClose - the function that handles the closing of the pop up.

...
type AudioInputOutputDevicesProps = {
  handleToggle: () => void;
  isOpen: boolean;
 ...
 * @param {() => void} props.handleToggle - Function to show or hide the menu.
 * @param {boolean} props.isOpen - Whether the menu is open or closed.
 * @param {RefObject<HTMLInputElement>} props.anchorRef - The reference element for the AudioInputOutputDevices component
 * @param {Function} props.handleClose - Function to close the menu.

...
import { MUTED_ALERT_MESSAGE } from '../../utils/constants';
import useSpeakingDetector from '../../hooks/useSpeakingDetector';
import usePublisherContext from '../../hooks/usePublisherContext';

type MutedAlertProps = {
 ...
 *
 * Displays a dismissible notification to the user if they're speaking while muted.
 * @param {MutedAlertProps} props - The props for the component.
 * @param {RefObject<HTMLInputElement>} props.anchorRef - The reference element for the MutedAlert component.
 * @returns {ReactElement} - The MutedAlert component.
 */
const MutedAlert = ({ anchorRef }: MutedAlertProps): ReactElement => {
  const { publisher, isAudioEnabled } = usePublisherContext();

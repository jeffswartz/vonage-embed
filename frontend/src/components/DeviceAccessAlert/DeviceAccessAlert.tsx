 ...
 * @param {string | null} props.accessStatus - the current access status.
 * @returns {ReactElement} - The rendered DeviceAccessAlert component
 */
const DeviceAccessAlert = ({ accessStatus }: DeviceAccessAlertProps): ReactElement => {
